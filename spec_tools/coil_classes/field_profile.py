...
class Field_profile:
    ...
    def __init__(self,list_coils,main_field=0):
        ...
        self.field_strength_interpolated_function = self.initialize_field_strength_interp()
    ...
    def field_grad(self,position,deriv_order=1,dx=1e-6,grad_coordinates="Cartesian"):
        ...
        for Bfield in Bfields:
            ...
            grad_r = derivative(fr,r[0],dx=dx,n=deriv_order,order=(deriv_order*2 + 1))
            ...
            grad_z = derivative(fz,r[2],dx=dx,n=deriv_order,order=(deriv_order*2 + 1))
    ...
    def initialize_field_strength_interp(self):
        """
        Creates a grid of field strengths based on field_strength() and fits it for much faster calls to this function. 
        """
        ...
        grid_edge_length = 5e-4 # (m), it was found that this grid_edge_length results in 1ppm agreement between field_stength and field_strength_interp
    ...
    def field_strength_interp(self,radius,zpos):
        ...
        """
        field_strength = self.field_strength_interpolated_function(radius,zpos)[0]
